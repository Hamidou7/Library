                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        ...
                        <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                            ...
                            <li>
                                <a href="{{route('forunisseur.index')}}" class="nav-link px-0"> <span class="d-none d-sm-inline">Fournisseur</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
...
<form action="{{route('Abonne.store')}}" method="post" enctype="multipart/form-data" >
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Editeur</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="editeur">
  </div>
