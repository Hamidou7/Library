  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <td>
        <p class="fw-normal mb-1">{{$item->entreprise}}</p>
      </td>
        <td>
        <p class="fw-normal mb-1">{{$item->contact}}</p>
      </td>
        <td>
        <p class="fw-normal mb-1">{{$item->adresse}}</p>
      </td>
      <td>
        <a type="button"  class="btn btn-link btn-rounded btn-sm fw-bold"  data-mdb-ripple-color="dark" href="{{route('Fournisseur.create')}}">
          Ajouter
        </a>
      </td>
       <td>
